...
{
    public class DesertTileset : Tileset
    {
        public DesertTileset(ContentLoader contentLoader)
            : base(contentLoader.LoadTexture(GraphicsHelper.DESERT_TILESET), 16, 16, 3) { }
        ...
        public override List<MapTileBuilder> DefineTiles()
        {
            ...
            //house wall
            Frame houseWallFrame = new FrameBuilder(GetSubImage(7, 2)).WithScale(TileScale).Build();
            ...
            // house door
            Frame houseDoorFrame = new FrameBuilder(GetSubImage(7, 3)).WithScale(TileScale).Build();

            MapTileBuilder houseDoorTile = new MapTileBuilder(houseDoorFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            MapTileBuilder houseStepsTile = new MapTileBuilder(houseStepsFrame).WithTileType(
                TileType.PASSABLE
            );
            ...
            MapTileBuilder houseFenceTile = new MapTileBuilder(houseFenceFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //house top
            Frame houseTopFrame = new FrameBuilder(GetSubImage(5, 4)).WithScale(TileScale).Build();
