...
namespace App.Tilesets
{
    public class SpookyTileset : Tileset
    {
        ...
        public override List<MapTileBuilder> DefineTiles()
        {
            ...
            MapTileBuilder grassfloorTile2 = new MapTileBuilder(grassfloorTile2Frame).WithTileType(
            ...
            // pumpkin decoration
            Frame pumpkinFrame = new FrameBuilder(GetSubImage(0, 3)).WithScale(TileScale).Build();

            MapTileBuilder pumpkinTile = new MapTileBuilder(pumpkinFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //Castle1
            Frame Castle1Frame = new FrameBuilder(GetSubImage(4, 0)).WithScale(TileScale).Build();

            MapTileBuilder Castle1Tile = new MapTileBuilder(Castle1Frame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //Castle7
            Frame Castle7Frame = new FrameBuilder(GetSubImage(1, 4)).WithScale(TileScale).Build();
            ...
            //Castle8
            Frame Castle8Frame = new FrameBuilder(GetSubImage(2, 4)).WithScale(TileScale).Build();

            MapTileBuilder Castle8Tile = new MapTileBuilder(Castle8Frame).WithTileType(
                TileType.PASSABLE
            );
            ...
            //Castle9
            Frame Castle9Frame = new FrameBuilder(GetSubImage(3, 4)).WithScale(TileScale).Build();

            MapTileBuilder Castle9Tile = new MapTileBuilder(Castle9Frame).WithTileType(
                TileType.PASSABLE
            );
            mapTiles.Add(Castle9Tile);

            //Castle10
            Frame Castle10Frame = new FrameBuilder(GetSubImage(4, 4)).WithScale(TileScale).Build();

            MapTileBuilder Castle10Tile = new MapTileBuilder(Castle10Frame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //gravel
            Frame gravelFrame = new FrameBuilder(GetSubImage(0, 5)).WithScale(TileScale).Build();

            MapTileBuilder gravelTile = new MapTileBuilder(gravelFrame).WithTileType(
                TileType.PASSABLE
            );
            ...
            //tree leaf
            Frame treeleafFrame = new FrameBuilder(GetSubImage(1, 5)).WithScale(TileScale).Build();
            ...
            //another tree
            Frame treeJawn = new FrameBuilder(GetSubImage(1, 4)).WithScale(TileScale).Build();
