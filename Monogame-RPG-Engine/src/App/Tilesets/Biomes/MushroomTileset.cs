...
namespace App.Tilesets
{
    public class MushroomTileset : Tileset
    {
        ...
        public override List<MapTileBuilder> DefineTiles()
        {
            ...
            //floor 2
            Frame floorFrame2 = new FrameBuilder(GetSubImage(0, 1)).WithScale(TileScale).Build();
            ...
            //floor 3
            Frame floorFrame3 = new FrameBuilder(GetSubImage(1, 0)).WithScale(TileScale).Build();
            ...
            //floor mushroom
            Frame mushroomFrame = new FrameBuilder(GetSubImage(1, 1)).WithScale(TileScale).Build();
            ...
            //branch 1
            Frame branch1Frame = new FrameBuilder(GetSubImage(2, 0)).WithScale(TileScale).Build();
            ...
            //branch 2
            Frame branch2Frame = new FrameBuilder(GetSubImage(3, 2)).WithScale(TileScale).Build();
            ...
            MapTileBuilder mushroomHouseTile = new MapTileBuilder(mushroomHouseFrame).WithTileType(
            ...
            MapTileBuilder mushroomDoorTile = new MapTileBuilder(mushroomDoorFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //window
            Frame windowFrame = new FrameBuilder(GetSubImage(3, 4)).WithScale(TileScale).Build();
            ...
            MapTileBuilder houseSide1Tile = new MapTileBuilder(houseSide1Frame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            MapTileBuilder houseSide2Tile = new MapTileBuilder(houseSide2Frame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //rock wall
            Frame rockWallFrame = new FrameBuilder(GetSubImage(0, 5)).WithScale(TileScale).Build();

            MapTileBuilder rockWallTile = new MapTileBuilder(rockWallFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //rock wall top
            Frame rockTopFrame = new FrameBuilder(GetSubImage(1, 5)).WithScale(TileScale).Build();

            MapTileBuilder rockTopTile = new MapTileBuilder(rockTopFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //top
            Frame topFrame = new FrameBuilder(GetSubImage(3, 5)).WithScale(TileScale).Build();

            MapTileBuilder topTile = new MapTileBuilder(topFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //side rock wall
            Frame sideRockFrame = new FrameBuilder(GetSubImage(4, 5)).WithScale(TileScale).Build();
            ...
            Frame floorFrame4 = new FrameBuilder(GetSubImage(0, 6)).WithScale(TileScale).Build();
            ...
            //rocks
            Frame rockFrame = new FrameBuilder(GetSubImage(1, 6)).WithScale(TileScale).Build();
            ...
            {
                new FrameBuilder(GetSubImage(5, 5), 30).WithScale(TileScale).Build(),
                new FrameBuilder(GetSubImage(6, 5), 30).WithScale(TileScale).Build(),
            };
            ...
            //soil
            Frame soilFrame = new FrameBuilder(GetSubImage(1, 6)).WithScale(TileScale).Build();
            ...
            //purple soil
            Frame soil1Frame = new FrameBuilder(GetSubImage(2, 7)).WithScale(TileScale).Build();
            ...
            {
                new FrameBuilder(GetSubImage(3, 6), 35).WithScale(TileScale).Build(),
                new FrameBuilder(GetSubImage(4, 6), 35).WithScale(TileScale).Build(),
                new FrameBuilder(GetSubImage(0, 7), 35).WithScale(TileScale).Build(),
            };
            ...
            //sign
            Frame signFrame = new FrameBuilder(GetSubImage(3, 7)).WithScale(TileScale).Build();

            MapTileBuilder signTile = new MapTileBuilder(signFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
            ...
            //fence
            Frame fenceFrame = new FrameBuilder(GetSubImage(4, 7)).WithScale(TileScale).Build();

            MapTileBuilder fenceTile = new MapTileBuilder(fenceFrame).WithTileType(
                TileType.NOT_PASSABLE
            );
