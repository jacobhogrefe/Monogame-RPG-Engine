...
namespace App.Tilesets
{
    public class MountainTileset : Tileset
    {
        ...
        public override List<MapTileBuilder> DefineTiles()
        {
            ...
            Frame frame60 = new FrameBuilder(GetSubImage(6, 0)).WithScale(TileScale).Build();
            ...
            Frame frame61 = new FrameBuilder(GetSubImage(6, 1)).WithScale(TileScale).Build();
            ...
            Frame frame62 = new FrameBuilder(GetSubImage(6, 2)).WithScale(TileScale).Build();
            ...
            Frame frame63 = new FrameBuilder(GetSubImage(6, 3)).WithScale(TileScale).Build();
            ...
            Frame frame64 = new FrameBuilder(GetSubImage(6, 4)).WithScale(TileScale).Build();
            ...
            Frame frame70 = new FrameBuilder(GetSubImage(7, 0)).WithScale(TileScale).Build();
            ...
            Frame frame71 = new FrameBuilder(GetSubImage(7, 1)).WithScale(TileScale).Build();
            ...
            MapTileBuilder specialTile = new MapTileBuilder(new FrameBuilder(GetSubImage(6, 3)).WithScale(TileScale).Build());
            specialTile.WithTileType(TileType.NOT_PASSABLE);
            mapTiles.Add(specialTile);

            // Row 8
            Frame frame80 = new FrameBuilder(GetSubImage(8, 0)).WithScale(TileScale).Build();
            ...
            Frame frame82 = new FrameBuilder(GetSubImage(8, 2)).WithScale(TileScale).Build();
            ...
            MapTileBuilder miscTile01 = new MapTileBuilder(miscFrame01).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile01);

            Frame miscFrame04 = new FrameBuilder(GetSubImage(0, 4)).WithScale(TileScale).Build();
            MapTileBuilder miscTile04 = new MapTileBuilder(miscFrame04).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile04);

            Frame miscFrame31 = new FrameBuilder(GetSubImage(3, 1)).WithScale(TileScale).Build();
            MapTileBuilder miscTile31 = new MapTileBuilder(miscFrame31).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile31);

            Frame miscFrame00 = new FrameBuilder(GetSubImage(0, 0)).WithScale(TileScale).Build();
            MapTileBuilder miscTile00 = new MapTileBuilder(miscFrame00).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile00);

            Frame miscFrame02 = new FrameBuilder(GetSubImage(0, 2)).WithScale(TileScale).Build();
            MapTileBuilder miscTile02 = new MapTileBuilder(miscFrame02).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile02);

            Frame miscFrame03 = new FrameBuilder(GetSubImage(0, 3)).WithScale(TileScale).Build();
            MapTileBuilder miscTile03 = new MapTileBuilder(miscFrame03).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile03);

            Frame miscFrame30 = new FrameBuilder(GetSubImage(3, 0)).WithScale(TileScale).Build();
            MapTileBuilder miscTile30 = new MapTileBuilder(miscFrame30).WithTileType(TileType.NOT_PASSABLE);;
            mapTiles.Add(miscTile30);

            Frame miscFrame11 = new FrameBuilder(GetSubImage(1, 1)).WithScale(TileScale).Build();
            MapTileBuilder miscTile11 = new MapTileBuilder(miscFrame11).WithTileType(TileType.NOT_PASSABLE);;
